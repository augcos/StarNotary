...
contract StarNotary is ERC721, ERC721Metadata('The Coolest Token','TCT') {
    ...
    // This has been performed through inheritance of the ERC712Metadata contract

    // mapping the Star Wwith the Owner Address
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender==ownerToken1||msg.sender==ownerToken2, 'You are not the owner of any of these tokens');
